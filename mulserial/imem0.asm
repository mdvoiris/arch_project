...
add $r12 $zero $imm 100//r12=256       $r5-  an element in the matrix wich we scan column after column $r6-an index in this matrix
lw $r3 $r4 $zero 0//for                $r11- counting how many elements were updated in the result matrix in each row
